...
def map(pos):
    if(pos==1):
        ...
        button = [
            [
             InlineKeyboardButton(text = 'Support Chat', url = "https://t.me/tzmclomebot"),
             InlineKeyboardButton(text = 'Feature Request', url = "https://github.com/thantzinmyothant1/G-Drive-Upload-Bot-V3")
            ],
